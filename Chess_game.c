...
int reset_plateau(void)
{
    ...
    plateau[0][2].piece = plateau[3][3].piece = "fn";
    ...
    plateau[4][6].piece = "db";
    plateau[4][4].piece = "rb";
...
/*int math(void)
{
    ...
    jn=roi(xn,yn,deplacement);
    jb=roi(xb,yb,deplacement);
